...
CSSGenerator['document'] = function (block) {
    var content_of_conjoined = CSSGenerator.statementToCode(block, 'content');
    var code = '<!DOCTYPE HTML>\n<html>\n' + content_of_conjoined + '</html>\n';
    return code;
};

//Header Code Generator
CSSGenerator['header'] = function (block) {
    var content_of_conjoined = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['title'] = function (block) {
    var content_of_conjoined = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['paragraph'] = function (block) {
    var content_of_conjoined = CSSGenerator.statementToCode(block, 'content');
...
//Body Elemento 
CSSGenerator['body'] = function (block) {
    var content_of_conjoined = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['image'] = function (block) {
...
CSSGenerator['newline'] = function (block) {
    return '<br>\n';
};
...
CSSGenerator['unorderedList'] = function (block) {
    var statements_content = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['orderedList'] = function (block) {
    var statements_content = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['listElem'] = function (block) {
    var statements_content = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['aside'] = function (block) {
    var width = block.getFieldValue('width');
    var position = block.getFieldValue('position');
    var colour = block.getFieldValue('colour');
    var content = CSSGenerator.statementToCode(block, 'NAME');
...
CSSGenerator['hyperlink'] = function (block) {
    var content = CSSGenerator.statementToCode(block, 'NAME');
...
CSSGenerator['descriptionList'] = function (block) {
    var statements_content = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['descriptionItem'] = function (block) {
    var itemInput = CSSGenerator.statementToCode(block, 'NAME') || '\n';
    var descriptionInput = CSSGenerator.statementToCode(block, 'NAMEDescription') || '\n';
...
CSSGenerator['heading'] = function (block) {
...
CSSGenerator['textWithStyle'] = function (block) {
    var htmlCode = "";
...
CSSGenerator['table'] = function (block) {
    var borderSize = block.getFieldValue('borderSize');
    var colour = block.getFieldValue('colour');
    var content = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['tableRow'] = function (block) {
    var borderSize = block.getFieldValue('borderSize');
    var colour = block.getFieldValue('colour');
    var content = CSSGenerator.statementToCode(block, 'content');
...
CSSGenerator['tableElement'] = function (block) {
    var borderSize = block.getFieldValue('borderSize');
    var colour = block.getFieldValue('colour');
    var content = CSSGenerator.statementToCode(block, 'content');
